...
include 'controllers/cfunciones.php';

// incluimos el archivo de configuracion
include 'controllers/cconfig.php';
...
if (isset($_POST['from'])) 
{
    ...
    $idres = _GET['idres'];
    {
        ...
        $link = "$base_url"."controllers/cdescripcion_evento.php?id=$id";
        ...
        (function($){
                ...
                var options = {
                    ...
                    // definimos que los eventos se mostraran en ventana modal
                        ...
                        events_source: '<?=$base_url?>controllers/cobtener_eventos.php', 
